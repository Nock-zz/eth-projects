...
var SharedComponent = function (_React$Component) {
  _inherits(SharedComponent, _React$Component);

  function SharedComponent(props) {
    _classCallCheck(this, SharedComponent);

    var _this = _possibleConstructorReturn(this, (SharedComponent.__proto__ || Object.getPrototypeOf(SharedComponent)).call(this, props));

    _this.state = { x: 1, y: 0 };
    _this.info = { author: "Nick" };
    return _this;
  }
...
var SayHello = function SayHello() {
  return _react2.default.createElement(SharedComponent, { render: function render(_ref) {
